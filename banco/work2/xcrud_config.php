...
{
    // default connection
    public static $dbname = 'sagatech_salt_fae'; // Your database name
    public static $dbuser = 'sagatech_fae_bi'; // Your database username
    public static $dbpass = 'q{*.@F^sl]^S'; // // Your database password
    public static $dbhost = '52.6.25.125'; // Your database host, 'localhost' is default.
    ...
    // alert settings
    public static $email_from = 'gpatricio.melo@gmail.com'; // email from address
    public static $email_from_name = 'Comanda'; // email from name
